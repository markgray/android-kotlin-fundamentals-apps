...
class MainActivity : AppCompatActivity() {
     ...
     * of `windowInsets` with [WindowInsetsCompat.Type.systemBars] as the argument. It then
     * gets the insets for the IME (keyboard) using [WindowInsetsCompat.Type.ime]. It then
     * updates the layout parameters of `v` to be a [ViewGroup.MarginLayoutParams]
