...
class MainActivity : ComponentActivity() {
     ...
     * layout file `R.layout.activity_main`. We initialize our [LinearLayout] variable `rootView` by
     * finding the view with ID `R.id.root_view`, then we use the
     ...
     * to the [WindowInsetsCompat.getInsets] of `windowInsets` with [WindowInsetsCompat.Type.systemBars]
