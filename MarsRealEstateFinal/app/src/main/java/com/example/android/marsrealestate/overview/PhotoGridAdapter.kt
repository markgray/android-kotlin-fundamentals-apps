...
class PhotoGridAdapter(
     ...
     * to the [MarsProperty] at position [position] in our dataset. We set the `OnClickListener`
     * of the `itemView` (root view) of our [MarsPropertyViewHolder] parameter [holder] to a lambda
     * which calls the `onClick` method of the [PhotoGridAdapter] property [onClickListener] with
     * `marsProperty`. Finally we call the `bind` method of our [MarsPropertyViewHolder] parameter
     * [holder] to have it bind to `marsProperty`.
     *
