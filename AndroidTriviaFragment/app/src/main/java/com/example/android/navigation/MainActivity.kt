...
class MainActivity : AppCompatActivity() {
     ...
     *
     * We initialize our [LinearLayout] variable `rootView` by finding the view with ID `R.id.root_view`
     * and call the [ViewCompat.setOnApplyWindowInsetsListener] method to set an
