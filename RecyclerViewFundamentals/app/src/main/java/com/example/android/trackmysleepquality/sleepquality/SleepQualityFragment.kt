...
class SleepQualityFragment : Fragment() {
     ...
     * our [SleepQualityViewModelFactory] with an instance constructed to use the `sleepNightKey`
     ...
     * initialize our [SleepQualityViewModel] variable `val sleepQualityViewModel` to our
