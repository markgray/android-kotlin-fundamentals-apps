...
class MainActivity : AppCompatActivity() {
     ...
     * field `var diceImage` by finding the view with ID [R.id.dice_image]. We initialize our
     * [ImageView] field `var diceImage2` by finding the view with ID [R.id.dice_image2].
     *
