...
class OverviewFragment : Fragment() {
     ...
     * `binding` to a new instance of [PhotoGridAdapter]. We initialize our [MenuHost] variable
     * `val menuHost` to to the `FragmentActivity` this fragment is currently associated with, then
     * call its [MenuHost.addMenuProvider] method to add our [MenuProvider] field [menuProvider] to
     ...
     * property of `binding`0 to the caller.
     *
