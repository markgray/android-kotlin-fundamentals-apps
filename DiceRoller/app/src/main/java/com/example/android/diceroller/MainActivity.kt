...
class MainActivity : AppCompatActivity() {
     ...
     * our layout file `R.layout.activity_main`. We initialize our [LinearLayout] variable `rootView`
     * to the view with ID `R.id.root_view` then call [ViewCompat.setOnApplyWindowInsetsListener] to
     * take over over the policy for applying window insets to `rootView`, with the `listener`
