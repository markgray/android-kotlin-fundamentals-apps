...
class MainActivity : AppCompatActivity() {
     ...
     * [binding] to the binding returned by the [DataBindingUtil.setContentView]
     * method when it inflates our `R.layout.activity_main` layout file and sets
     * it as our content view. We then call [ViewCompat.setOnApplyWindowInsetsListener]
     * to take over over the policy for applying window insets to the root view of
     * [binding], with the listener argument a lambda that accepts the [View] passed the
     ...
     * and the bottom margin set to `insets.bottom`. Next it returns
