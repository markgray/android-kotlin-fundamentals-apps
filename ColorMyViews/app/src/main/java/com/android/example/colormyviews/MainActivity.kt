...
class MainActivity : AppCompatActivity() {
     ...
     * [WindowInsetsCompat.Type.ime]. It then updates the layout parameters of `v` to
     * be a [ViewGroup.MarginLayoutParams] with the left margin set to `systemBars.left`,
     * the right margin set to `systemBars.right`, the top margin set to `systemBars.top`,
     * and the bottom margin set to the maximum of the system bars bottom inset and the IME
     * bottom inset. Finally it returns [WindowInsetsCompat.CONSUMED] to the caller (so that
