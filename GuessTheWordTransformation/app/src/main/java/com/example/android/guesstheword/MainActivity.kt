...
class MainActivity : AppCompatActivity() {
     ...
     * view to our layout file `R.layout.main_activity` (it contains a [NavHostFragment] with an
     * app:navGraph="@navigation/main_navigation" attribute which causes all the fragment
     * navigation to be defined by the navigation/main_navigation.xml file. The [TitleFragment]
     * is the home (or starting fragment) for the app as specified by the
